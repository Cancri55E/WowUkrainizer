...
ns._db.Changelogs = {
    {
        ...
        author = "Cancri",
        title = nil,
        description = [[|cffFFD150Нова функція: Переклади підказок предметів.|r

Тепер ви побачите локалізовані підказки при наведенні на ігрові предмети. Ви можете керувати цією функцією через налаштування.
Переклад все ще в процесі, але команда перекладачів активно працює над перекладом імен, описів та ефектів предметів.
