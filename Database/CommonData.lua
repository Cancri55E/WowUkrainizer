...
ns._db.SpecializationNotes = {
	...
	[3200539494] = "Здібний слідопит, який віддає перевагу використанню вибухівки, отрути тварин та скоординованим атакам з прирученим звіром.\n\nБажана зброя: держакова зброя, посох",
	...
	[3483923889] = "Використовує магію, щоб захистити союзників від ушкоджень, а також зцілити їхні рани.\n\nБажана зброя: посох, жезл, кинджал, дробильна зброя",
...
ns._db.SplashFrames = {
	...
	[2263882995] = "Ваші персонажі отримують доступ до банку бойового загону, репутацій Dragonflight та іншого!",
