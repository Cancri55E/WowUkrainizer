...
do
    ...
    [[Дякуємо, що обрали наш додаток для занурення у захопливий світ Азероту. За допомогою цього майстра налаштувань ви зможете легко адаптувати додаток під себе.

Ви маєте можливість вибрати, які саме частини гри будуть перекладені: текстові діалоги, завдання, інтерфейс чи весь контент разом. Крім цього, у вас є можливість налаштувати візуальне оформлення додатка.

Якщо ви хочете почати грати негайно, просто скористайтеся кнопкою "Залишити стандартні налаштування", і наш додаток автоматично підбере оптимальні параметри.

Зробіть свій ігровий досвід ще приємнішим і зручнішим з українізатором.

Приємної гри!]]
    local WOW_UKRAINIZER_WELCOME_PAGE_LEAVE_DEFAULT_BUTTON_TEXT = "Залишити стандартні налаштування"
...
do
    ...
    WowUkrainizerModuleSettingsPageMixin.UIFontStringTexts = {
        ...
        [2] = "Є повна сумісність з додатками, як-от Plater та ElvUI.",
        [3] = "Переклад буде застосовано до спливного тексту під час переходу між локаціями, а також до тексту на карті та мінікарті.",
        [4] = "Субтитри та діалоги",
        [5] = "Додає переклад для субтитрів у пререндерованих відеороликах гри (не плутати з кат-сценами).",
        [6] = "Додає переклад діалогів неігрових персонажів. Перекладений текст буде відображатися у вікні чату, у «бульбашках» над " ..
            "головою персонажа, a також у кат-сценах. |n|nУВАГА! Через обмеження, які ввела компанія Blizzard в ігровому клієнті, " ..
            "переклад діалогів всередині групового контенту (підземелля, рейди та ін.) можливий лише в чаті гри. Текст у бульбашках залишатиметься англійським.",
        [7] = "Завдання",
        [8] = "Додає переклад ігрових завдань і пов'язанних з ними елементів гри. Будуть перекладені не лише тексти самих завдань, " ..
            "а й вікна, які відповідають за їхнє відображення, позначки завдань на карті світу та мінікарті. Також буде перекладений список " ..
            ...
            "Ба більше, поруч буде ще одна кнопка, яка дозволить вам скопіювати посилання на Wowhead з описом завдання.",
        [9] = "«World of Warcraft» має тисячі завдань та мільйони слів, які необхідно перекласти. З силою фанатів переклад може тривати роками. " ..
            "Тому було вирішено додати машинний переклад за допомогою ШІ, щоб пришвидшити переклад завдань, а ті хто погано розуміють англійську, змогли " ..
            "насолоджуватися грою вже зараз.|n|nПріоритет перекладу від ШІ завжди нижче від перекладу, який зробила людина. Додаток автоматично буде використовувати " ..
            "переклад, зроблений людиною, якщо він є у наявності.|n|nУ вікні з текстом завдання поруч з кнопкою перемикання перекладу буде відображена " ..
            "спеціальна піктограма (голова робота), якщо ви бачите повний або частковий машинний переклад.",
    }
...
do
    ...
    [[Друзі, дякую вам за те, що обрали грати українською і вірите в наш проєкт.
